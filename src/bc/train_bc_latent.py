...
def build_parser():
    ...
    parser.add_argument("--latent-representation", "--latent_representation", dest="latent_representation", choices=LEWM_LATENT_REPRESENTATIONS, help="Frozen LeWM feature consumed by BC: raw encoder CLS or the learned JEPA-projected CLS")
